function [Priors, Mu, Sigma, expData, Pix] = GMM(Data, nbStates, numFrame, action)
%
...
[Priors, Mu, Sigma, Pix] = EM(Data, Priors, Mu, Sigma);
...
expData(1,:) = linspace(1, numFrame, numFrame);
